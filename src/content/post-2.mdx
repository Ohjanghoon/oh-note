export const metadata = {
  title: "Next.js 블로그에 GitHub 댓글 기능 추가하기 (with. utterances)",
  description:
    "utterance를 활용하여 Next.js 블로그에 간편하게 GitHub 댓글 기능 추가하기",
  publishDate: "2025-03-19T11:38:00Z",
  thumbnailUrl: "/assets/blog/posts/post-2/post-2_thumbnail.png",
  tags: ["Blog", "Next.js", "utterance", "댓글", "GitHub"],
};
...
<ImageBox src={"/assets/blog/posts/post-2/post-2_01-utterances_install.png"} alt="utterances_install" about="utterances_install image"/>
<br/>
3. 여기서 이슈를 관리할 레포지토리를 선택해줍니다.
<ImageBox src={"/assets/blog/posts/post-2/post-2_02-utterances_install.png"} alt="utterances_install" about="utterances_install image"/>
...
<ImageBox src={"/assets/blog/posts/post-2/post-2_03-utterances_install.png"} alt="utterances_install" about="utterances_install image"/>
...
<ImageBox src={"/assets/blog/posts/post-2/post-2_05-utterances_nextjs.png"} alt="utterances_nextjs" about="utterances_nextjs image"/>
<ImageBox src={"/assets/blog/posts/post-2/post-2_06-utterances_nextjs.png"} alt="utterances_nextjs" about="utterances_nextjs image"/>
<br/>
댓글을 작성하면 pathname에 맞춰 해당 게시글의 이슈가 생성된 것을 확인할 수 있습니다.
<ImageBox src={"/assets/blog/posts/post-2/post-2_07-utterances_nextjs.png"} alt="utterances_nextjs" about="utterances_nextjs image"/>
<br />
<br />
...
<ImageBox src={"/assets/blog/posts/post-2/post-2_08_utterances_dark.gif"} alt="utterances_nextjs" about="utterances_nextjs image"/>
<br/>
<br/>
