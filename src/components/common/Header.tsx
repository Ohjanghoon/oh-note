...
function Header() {
  ...
  return (
    <header
      className={`root-header border-border fixed flex h-18 items-center justify-between gap-x-10 px-10 py-2 transition-[background-color] duration-200 ${isScroll ? "bg-background border-b-1" : "bg-transparent"}`}
    >
      {/* <header
