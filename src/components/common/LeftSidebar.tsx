...
function LeftSidebar() {
  ...
  return (
    <motion.aside
      ...
      className={`left_sidebar-aside border-border hidden h-[calc(100vh-4rem)] space-y-2 border-r shadow-lg transition-[width,opacity,background-color,color,border-color] duration-300 ${isOpen || isPinned ? "bg-bg-subtle w-58" : "bg-bg-subtle/80 w-19"} top-16 z-50 lg:fixed lg:block`}
