...
function GradientBackground() {
  return (
    <>
      <div className="gradient-background absolute top-0 left-0 -z-50 h-[40vh] w-full overflow-hidden bg-[linear-gradient(135deg,#62a1f7,transparent,#62a1f7,transparent,#62a1f7,#aab9d2,transparent)] opacity-20 blur-3xl"></div>
