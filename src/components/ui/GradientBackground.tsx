...
function GradientBackground() {
  return (
    <>
      <div className="gradient-background visible absolute top-0 left-0 w-full overflow-hidden bg-[linear-gradient(180deg,#62a1f780,#62a1f7,#62a1f780,#62a1f7,var(--color-background))] opacity-25 blur-3xl transition-none lg:h-[50vh] dark:opacity-20"></div>
