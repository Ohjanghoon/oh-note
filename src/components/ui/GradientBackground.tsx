...
function GradientBackground() {
  return (
    <>
      <div className="gradient-background visible absolute top-0 left-0 -z-50 h-[40vh] w-full overflow-hidden bg-[linear-gradient(180deg,#62a1f780,#62a1f7,#62a1f780,#62a1f7,#62a1f780)] opacity-20 blur-3xl dark:invisible"></div>
