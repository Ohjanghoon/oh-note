...
function GradientBackground() {
  return (
    <>
      <div className="gradient-background visible absolute top-0 left-0 -z-11 w-full overflow-hidden bg-[linear-gradient(180deg,#62a1f780,#62a1f7,#62a1f780,#62a1f7,var(--color-background))] opacity-20 blur-3xl lg:h-[40vh]"></div>
